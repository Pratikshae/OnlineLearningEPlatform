...
public class AdminController {
	...
	public String openFeedbackPage(@SessionAttribute(value = "sessionAdmin", required = false) Admin admin,
			                       Model model,
	...
	public String updateFeedbackStatus(@SessionAttribute(value = "sessionAdmin", required = false) Admin admin,
